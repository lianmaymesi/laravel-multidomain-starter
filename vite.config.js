...
// Static assets referenced via Vite::asset() in Blade (not imported by any
// JS/CSS entry) need to be declared as build inputs too, or they're missing
// from manifest.json and Vite::asset() throws in production.
const staticAssetEntries = ["resources/assets/images/logo.svg"];

export default defineConfig({
    plugins: [
        laravel({
            input: [...portalEntries(), ...staticAssetEntries],
            refresh: true,
        }),
        tailwindcss(),
    ],
