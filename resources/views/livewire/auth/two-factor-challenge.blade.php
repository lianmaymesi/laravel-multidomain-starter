    ...
    <div class="flex flex-col gap-6">
        <div class="relative h-auto w-full" x-cloak x-data="{
            ...
            <div x-show="!showRecoveryInput">
                <x-common.auth-header :title="__('Authentication code')" :description="__('Enter the authentication code provided by your authenticator application.')" />
            </div>

            <div x-show="showRecoveryInput">
                <x-common.auth-header :title="__('Recovery code')" :description="__(
