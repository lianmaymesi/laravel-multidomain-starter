    ...
    <div class="flex flex-1 items-center justify-center px-4 py-12">
        <div class="w-full max-w-sm">
            ...
            <div class="mb-6 border-s-[3px] border-blue-500 ps-4">
                <p class="mb-1 text-[10px] tracking-[0.25em] uppercase text-blue-500 dark:text-blue-400/55">Security
                    check</p>
                <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Two-factor check</h1>
                <p class="mt-1 text-sm text-zinc-500 dark:text-white/40">Confirm it's you to finish signing in</p>
            </div>
                ...
                <div class="flex items-center gap-3 border border-blue-400/20 bg-blue-50 dark:bg-blue-400/5 px-4 py-3">
                    ...
                    <div>
                        ...
                        <p class="mt-0.5 text-xs text-zinc-500 dark:text-white/45">
                            {{ $usingRecovery ? 'Enter one of your emergency recovery codes.' : 'Open your authenticator
