...
<div class="flex min-h-screen">
    ...
    {{-- ── Brand panel ──────────────────────────────────────────────────── --}}
    <div class="relative hidden overflow-hidden border-r border-white/6 bg-blue-950 lg:flex lg:w-[42%] lg:flex-col">
    ...
    <div class="flex flex-1 flex-col bg-zinc-950">
        ...
        <div class="flex h-12 items-center justify-between border-b border-white/6 px-6 lg:px-10">
            ...
            <div class="flex items-center gap-2 text-xs text-white/35">
                No account?
                <flux:link href="{{ route('auth.register') }}" wire:navigate class="font-medium! text-white/70! hover:text-white!">
                    Create one
                </flux:link>
            </div>
        </div>
        ...
        <div class="flex flex-1 items-center justify-center px-6 py-10 lg:px-16">
            <div class="w-full max-w-sm">
                ...
                <div class="mb-7 border-l-[3px] border-blue-500 pl-4">
                    <p class="mb-1 text-[10px] tracking-[0.3em] uppercase text-blue-400/55">Account access</p>
                ...
                @if (session('deletion_requested'))
                    <div class="mb-5 border border-amber-500/20 bg-amber-500/6 p-4">
                        ...
                        <p class="mt-1.5 pl-5 text-xs leading-relaxed text-white/45">
                            Your account will be permanently deleted in
                            <span class="text-white/75">{{ \App\Models\AccountDeletionRequest::GRACE_PERIOD_DAYS }} days</span>.
