    ...
    <div class="flex flex-1 items-center justify-center px-4 py-12">
        <div class="w-full max-w-sm">
            ...
            <div class="mb-6 border-l-[3px] border-blue-500 pl-4">
                <p class="mb-1 text-[10px] tracking-[0.25em] uppercase text-blue-400/55">Account security</p>
            ...
            <flux:card class="p-5!">
                ...
                @if ($status === 'success')
                    ...
                    <div class="space-y-5 text-center">
                        <div class="flex justify-center">
                            <div class="flex h-14 w-14 items-center justify-center border border-emerald-500/20 bg-emerald-500/8">
                                <flux:icon.check-circle class="size-7 text-emerald-400" />
                            </div>
                        </div>
                        <div>
                            <p class="text-base font-semibold text-white">Email updated</p>
                ...
                @elseif ($status === 'expired')
                    ...
                    <div class="space-y-5 text-center">
                        <div class="flex justify-center">
                            <div class="flex h-14 w-14 items-center justify-center border border-amber-500/20 bg-amber-500/8">
                                <flux:icon.clock class="size-7 text-amber-400" />
                            </div>
                        </div>
                        <div>
                            <p class="text-base font-semibold text-white">Link expired</p>
                ...
                @else
                    ...
                    <div class="space-y-5 text-center">
                        ...
                        <div>
                            <p class="text-base font-semibold text-white">Invalid link</p>
                            <p class="mt-1 text-sm text-white/50">
