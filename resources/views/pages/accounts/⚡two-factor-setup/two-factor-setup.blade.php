...
<div class="space-y-8">
    ...
    <div class="grid gap-6 lg:grid-cols-[1fr_auto]">
        ...
        <div class="space-y-5">
            ...
            <div class="rounded-[1.75rem] border border-zinc-200 dark:border-white/[0.07] bg-zinc-50 dark:bg-white/3 p-6 space-y-4">
                ...
                <div class="flex justify-center pt-2 lg:hidden">
                    <div class="inline-block rounded-2xl border border-zinc-200 dark:border-white/10 bg-white p-3 shadow-lg">
                        {!! $qrCodeSvg !!}
                    </div>
                </div>
            </div>
            ...
            {{-- Step 2: enter code --}}
            <div class="rounded-[1.75rem] border border-zinc-200 dark:border-white/[0.07] bg-zinc-50 dark:bg-white/3 p-6 space-y-5">
                <div class="flex items-center gap-3">
                    <span
        ...
        <div class="hidden lg:flex lg:items-start lg:pt-1">
            <div class="rounded-2xl border border-zinc-200 dark:border-white/10 bg-white p-4 shadow-xl">
                {!! $qrCodeSvg !!}
            </div>
        </div>
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-[1.75rem] border border-zinc-200 dark:border-white/[0.07] bg-zinc-50 dark:bg-white/3 p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
                ...
                <div class="rounded-xl border border-zinc-200 dark:border-white/[0.07] bg-zinc-50 dark:bg-white/4 px-3 py-2 text-center">
                    <code class="text-xs font-mono tracking-wider text-zinc-700 dark:text-white/70">{{ $code }}</code>
                </div>
                @endforeach
            </div>
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-[1.75rem] border border-zinc-200 dark:border-white/[0.07] bg-zinc-50 dark:bg-white/3 p-6 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
                ...
                <div class="rounded-xl border border-zinc-200 dark:border-white/[0.07] bg-zinc-50 dark:bg-white/4 px-3 py-2 text-center">
                    <code class="text-xs font-mono tracking-wider text-zinc-700 dark:text-white/70">{{ $recoveryCode }}</code>
                </div>
                @endforeach
            </div>
