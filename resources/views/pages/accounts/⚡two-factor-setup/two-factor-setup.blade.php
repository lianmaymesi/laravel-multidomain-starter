    ...
    <div class="space-y-6">
        ...
        <div class="rounded-[1.75rem] border border-white/[0.07] bg-white/3 p-6 space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                @else
                <flux:button icon="eye" wire:click="viewRecoveryCodes" size="sm" variant="ghost" class="rounded-2xl!">
                    View recovery codes
                </flux:button>
                @endif
                <flux:button icon="arrow-path" wire:click="regenerateRecoveryCodes"
                    ...
                    size="sm" variant="ghost" class="rounded-2xl!">
                    Regenerate codes
                </flux:button>
            </div>
        </div>
        ...
        <div class="rounded-[1.75rem] border border-white/[0.07] bg-white/3 p-6 space-y-4">
            ...
            <div class="flex flex-wrap gap-2">
                <flux:button icon="qr-code" wire:click="reconfigure" size="sm" variant="ghost" class="rounded-2xl!">
                ...
                <flux:button wire:click="disable"
                    ...
                    variant="danger" class="rounded-2xl!">
                    Disable 2FA
                </flux:button>
            </div>
        </div>
