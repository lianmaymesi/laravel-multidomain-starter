...
<div class="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 py-16 sm:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
        ...
        <h1 class="mt-6 text-4xl leading-tight font-semibold tracking-tight text-zinc-900 dark:text-white sm:text-5xl">
            One codebase.<br>
            <span class="text-blue-600 dark:text-blue-400">Every</span> domain.
        </h1>
    ...
    <div class="mx-auto mt-16 grid w-full max-w-4xl grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <flux:card as="a" href="https://github.com/lianmaymesi/laravel-multidomain-starter/blob/main/config/multidomain.php"
            ...
            <flux:text class="text-sm text-zinc-500 dark:text-white/50">Each portal is registered in <code class="text-zinc-700 dark:text-white/70">config/multidomain.php</code> and routed with <code class="text-zinc-700 dark:text-white/70">Route::domain()</code> — no shared middleware, no namespace bleed.</flux:text>
            <flux:text class="text-sm text-blue-600 dark:text-blue-400">View config →</flux:text>
        </flux:card>
        ...
        <flux:card as="a" href="https://github.com/lianmaymesi/laravel-multidomain-starter/blob/main/app/Console/Commands/MakeSubdomainCommand.php"
            ...
            <flux:text class="text-sm text-zinc-500 dark:text-white/50"><code class="text-zinc-700 dark:text-white/70">php artisan make:subdomain</code> generates the route file, layout, Vite assets and a starter dashboard for a brand-new portal instantly.</flux:text>
            <flux:text class="text-sm text-blue-600 dark:text-blue-400">View command →</flux:text>
        </flux:card>
        ...
        <flux:card as="a" href="https://livewire.laravel.com" target="_blank" rel="noopener" class="space-y-2">
            ...
            <flux:text class="text-sm text-zinc-500 dark:text-white/50">Pages are single-file Livewire components — reactive, server-driven UI in every portal, no separate API layer required.</flux:text>
            <flux:text class="text-sm text-blue-600 dark:text-blue-400">Livewire docs →</flux:text>
        </flux:card>
        ...
        <flux:card as="a" href="https://fluxui.dev" target="_blank" rel="noopener" class="space-y-2">
            ...
            <flux:text class="text-sm text-zinc-500 dark:text-white/50">Every portal shares the same Flux UI components and theme tokens, so new subdomains look consistent from the first commit.</flux:text>
            <flux:text class="text-sm text-blue-600 dark:text-blue-400">Flux UI docs →</flux:text>
        </flux:card>
